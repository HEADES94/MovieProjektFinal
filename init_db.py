"""
Initialisiert die komplette Datenbank mit allen erforderlichen Tabellen und Grunddaten
"""
from data_models import init_db, Base
from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker
from data_models import Achievement, User, Movie

# Datenbank-URL
DB_URL = "sqlite:///movie_app.db"

def init_database():
    # Erstelle Engine und initialisiere Datenbank
